...
追記　Yaochenxu
 * 2016/Oct/16
 get_which_day()を追加、日付により祝日＆曜日を戻す
...
def get_which_day(search_date):
    if holiday_name(search_date.year,search_date.month,search_date.day) is not None:
        return '祝'
    else:
        weekday = ['月','火','水','木','金','土','日']
        return weekday[search_date.weekday()]
